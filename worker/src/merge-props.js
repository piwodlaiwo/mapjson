...
const ALL_PROP_KEYS = ['name', 'nameOfficial', 'iso2', 'iso3', 'isoNum', 'continent', 'subregion', 'areakm2', 'population', 'gdp', 'capital', 'capitalLat', 'capitalLng', 'currencies', 'languages', 'idd', 'demonym', 'flag', 'borders'];
